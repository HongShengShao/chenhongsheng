 ...
 * @author 陈宏升
 * @类的作用：
 * @data 2017/4/19 19:51
 */
public class TwoEffectFragmentPager extends Fragment {

    private int position;
    private RecyclerView recyclerView;
    private Integer[] integer=new Integer[]{17,31,19,18,20};
    ...
    private void getData() {
        String url = "http://m.yunifang.com/yunifang/mobile/goods/getall?random=91873&encode=68301f6ea0d6adcc0fee63bd21815d69&category_id=" + integer[position];

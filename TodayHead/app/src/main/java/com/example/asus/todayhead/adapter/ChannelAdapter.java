...
import com.example.asus.todayhead.helper.OnDragVHListener;
import com.example.asus.todayhead.helper.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    // 我的频道点击事件
    public OnMyChannelItemClickListener mChannelItemClickListener;
